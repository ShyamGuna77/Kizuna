      ...
      <AnimatedSection className="py-16 bg-pink-100">
        <div className="container mx-auto px-4">
          <motion.div variants={fadeInUp} className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Featured Singles</h2>
            <p className="text-xl max-w-2xl mx-auto">
              Meet some of our amazing singles ready to connect. Our community
              is growing every day with people looking for love!
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className={`${profile.color} rounded-xl border-3 border-black p-4 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)]`}
              >
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {profile.interests.map((interest, i) => (
                    <span
                      key={i}
                      className="bg-white px-2 py-1 rounded-md border border-black text-sm"
                    >
                      {interest}
                    </span>
                  ))}
